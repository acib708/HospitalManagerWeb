...
<script>
    document.getElementById('form_consultar_analisis').submit();
...
<s:form id="form_consultar_analisis" name="form_consultar_analisis" action="consultarAnalisisGeneral" method="GET" target="results_frame">
</s:form>