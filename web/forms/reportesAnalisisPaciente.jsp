...
<s:form name="form_generar_reporte_analisis_paciente" action="generarReporteAnalisisPaciente" method="GET" target="results_frame">
    <table  style="width:30%; margin:auto;">
        ...
        <tr>
            <td></td>
            <td>
                <input type="submit" class="btn btn-primary" style="width:200px;" value ="Enviar"  onClick="validateFormCapturar();  iframeGo('reportesAnalisisPaciente2.jsp'); resizeFrame(); showFrame();"/>
            </td>
        </tr>
    </table>
</s:form>