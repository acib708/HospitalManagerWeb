...
<script>
    document.getElementById('form_consultar_pacientes').submit();
...
<s:form id="form_consultar_pacientes" name="form_consultar_pacientes" action="consultarPacienteGeneral" method="GET" target="results_frame">
</s:form>